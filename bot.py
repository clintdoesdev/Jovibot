"""
Jovia Network Telegram Userbot + Live Dashboard
==========================================
...
- A social-referral opener (see matches_social_interest), e.g. "From
  ...
  explanation of Jovia + the public Telegram channel link, then silent for
  good) only runs when FACEBOOK_FLOW_ENABLED is set — off by default for
  now, so a social-style opener is just handled by the main funnel above
...
# without touching any code. This should be your real Jovia registration
# link — https://joviawebsite.com.ng by default.
SIGNUP_URL = os.environ.get("SIGNUP_URL", "https://joviawebsite.com.ng")

# One-time registration fees for each package. Quoted wherever a reply
# mentions the cost of joining. Change these via env vars if pricing ever
# changes without touching any code.
GOLD_FEE   = os.environ.get("GOLD_FEE", "₦15,000")
SILVER_FEE = os.environ.get("SILVER_FEE", "₦9,000")

# Master switch for the separate social-referral flow (short welcome ->
# name -> subtle explanation + channel link). Off by default — while off,
# a social-style opener ("From Facebook, I'm Interested in...") is just
...
JOVIA_WELCOME_MESSAGE = (
    ...
    "HOW JOVIA WORKS\n\n"
    "Jovia is a digital income platform where users can earn from digital "
    "activities, content, games, music, sales and more. 💻\n\n"
    "📦 AVAILABLE PACKAGES: 2\n\n"
    "━━━━━━━━━━━━━━━━━━\n"
    "🥇 JOVIA GOLD\n"
    "━━━━━━━━━━━━━━━━━━\n\n"
    f"💰 Registration: {GOLD_FEE}\n\n"
    f"• 🎁 Earn {GOLD_FEE} from Smash Bonus\n"
    "• 💵 Earn ₦13,000 from each Direct Sale\n"
    "• 🎬 Earn ₦3,000 from Celebrity Videos (30sec)\n"
    "• 🎮 Earn ₦6,000 from Fun Games (60sec)\n"
    "• 📱 Earn ₦3,000 from Meta Activities\n"
    "• 🎵 Earn ₦2,000 from Music Streaming\n"
    "• 🔄 Earn ₦400–₦600 from Spillovers\n"
    "• 🎁 Earn $10 from Friday Bonus (FBR)\n"
    "• 🤖 Jovia AI: Active\n\n"
    "⏰ Time: Adjustable from 30sec–1hr\n\n"
    "\n"
    "━━━━━━━━━━━━━━━━━━\n"
    "🥈 JOVIA SILVER\n"
    "━━━━━━━━━━━━━━━━━━\n\n"
    f"💰 Registration: {SILVER_FEE}\n\n"
    f"• 🎁 Earn {SILVER_FEE} from Smash Bonus\n"
    "• 💵 Earn ₦7,000 from each Direct Sale\n"
    "• 🎬 Earn ₦1,500 from Celebrity Videos (30sec)\n"
    "• 🎮 Earn ₦3,000 from Fun Games (60sec)\n"
    "• 📱 Earn ₦2,000 from Meta Activities\n"
    "• 🎵 Earn ₦1,000 from Music Streaming\n"
    "• 🔄 Earn ₦200–₦400 from Spillovers\n\n"
    "⏰ Time: Fixed\n"
    "❌ FBR & Jovia AI: Not Active\n\n"
    "\n"
    "💳 WITHDRAWALS\n\n"
    "Tuesday & Sunday\n"
    "🎁 FBR: Every Friday (Gold)\n\n"
    "Choose your package and unlock your available earning features.\n\n"
    "Are you ready to Register? 🚀"
)

# ── Social-referral entry point: Facebook/Instagram/etc. "interested" openers
...
SOCIAL_CHANNEL_URL = os.environ.get(
    "SOCIAL_CHANNEL_URL", "https://t.me/joviaofficial"
)

SOCIAL_WELCOME_REPLIES = [
    (
        "🌹 Hey, welcome to Jovia Network 🎉\n\n"
...
SOCIAL_EXPLAINER_BODIES = [
    (
        "Nice to meet you, {name}. Jovia is a digital income platform that pays you for "
        "digital activities, content, games, music, sales and more.\n\n"
...
# ── Step 2: signup link — plain fixed template with a {name} placeholder,
#    filled in by build_signup_message() below.
SIGNUP_MESSAGE = (
    "🟡 Perfect, {name}! You're just one step away from getting started with Jovia.\n\n"
    "Quick steps to get you in:\n\n"
    "1️⃣ Open the link below\n"
    f"2️⃣ Pick your package — 🥇 Gold ({GOLD_FEE}) or 🥈 Silver ({SILVER_FEE})\n"
    "3️⃣ Complete your registration payment\n"
    "4️⃣ Send your payment receipt back here\n\n"
...
SIGNUP_LINK_REMINDER = (
    ...
    f"👇 {SIGNUP_URL}\n\n"
    f"It's a one-time {GOLD_FEE} for Gold or {SILVER_FEE} for Silver to join Jovia, "
    "then you can start earning right away 🚀"
)

REFERRAL_INFO_REPLY = (
    "💵 Direct Sale & Spillover Rewards\n\n"
    f"You earn every time someone joins Jovia through you — a Direct Sale pays ₦13,000 on "
    f"Gold or ₦7,000 on Silver, on top of your own Smash Bonus.\n\n"
    "Spillovers also add ₦400–₦600 (Gold) or ₦200–₦400 (Silver) automatically from the "
    "wider network, even without your own referral.\n\n"
    "Register to unlock your personal link and start earning 🚀\n\n"
    f"👇 {SIGNUP_URL}"
)
...
# payment for Jovia Gold, please drop the payment link". Deliberately
...
PAYMENT_READY_PHRASES = [
    ...
    "payment link please", "jovia gold payment", "jovia silver payment",
    "pay for jovia gold", "pay for jovia silver", "pay for jovia",
    "make payment for jovia", "ready to register for jovia",
]
...
# Someone reporting they've ALREADY paid, e.g. "Just made payment for
# jovia, here's my receipt" — different from PAYMENT_READY_PHRASES above
...
# "From Facebook, I'm Interested in getting started with Jovia". Mentions a
# source PLUS interest in Jovia. Runs a shorter script than the main
# funnel (see SOCIAL_WELCOME_REPLIES / SOCIAL_EXPLAINER_BODIES above) that
# ends in the public Telegram channel link instead of the registration page.
...
SOCIAL_INTEREST_PHRASES = [
    ...
    "getting started with jovia", "get started with jovia",
    "how do i join jovia", "want to know more about jovia",
]

def matches_social_interest(text: str) -> bool:
    t = text.lower()
    has_source = any(p in t for p in SOCIAL_SOURCE_PHRASES)
    has_interest = any(p in t for p in SOCIAL_INTEREST_PHRASES) or "jovia" in t
...
ALREADY_JOINED_PHRASES = [
    ...
    "i already have an account", "i already have a jovia account",
...
JOIN_KEYWORDS = [
    ...
    "i want to pick gold", "i want to pick silver", "i want gold",
    "i want silver", "i choose gold", "i choose silver",
]
...
INFO_TRIGGERS = [
    "how jovia work", "jovia work how", "what is jovia", "tell me about jovia",
    "explain jovia", "how does it work", "tell me more", "more info", "more details",
    ...
    "what is the fee", "how much is it", "how much to start",
    "what is smash bonus", "what is direct sale", "what is celebrity videos",
    "what is fun games", "what is meta activities", "what is music streaming",
    "what is spillover", "what are spillovers", "what is fbr", "what is friday bonus",
    "what is jovia ai", "what is jovia gold", "what is jovia silver",
    "difference between gold and silver", "gold or silver", "which package",
    "what package", "what's the difference",
]
...
REFERRAL_TRIGGERS = [
    ...
    "direct sale", "direct sales", "how does direct sale work",
    "spillover", "spillovers", "how do spillovers work", "how does spillover work",
    "who do i refer", "invite friends", "invite a friend",
]
...
daily_history: list = []  # last 7 days [{date, messages, new_chats, replies, flags, welcomed, signup_sent}]
...
log = logging.getLogger("jovia-bot")
    ...
    for sub in list(push_subscriptions):
        try:
            webpush(
                ...
                vapid_claims={"sub": "mailto:support@joviawebsite.com.ng"},
            )
        except Exception as e:
            s = str(e)
...
self.addEventListener('push', e => {
  const d = e.data ? e.data.json() : {title:'Jovia Network Bot',body:'Alert'};
  e.waitUntil(self.registration.showNotification(d.title||'Jovia Network Bot', {
    body:d.body||'', tag:'jovia-bot', requireInteraction:true, vibrate:[200,100,200]
  }));
});
...
MANIFEST_JSON = json.dumps({
    "name": "Jovia Network Bot",
    "short_name": "Jovia",
    "description": "Jovia Network Telegram Bot — Live Console",
    "start_url": "/",
    "display": "standalone",
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
  ...
  <text x="256" y="304" font-family="Georgia, 'Times New Roman', serif" font-size="204" font-weight="700"
        fill="url(#g)" text-anchor="middle">J</text>
</svg>"""
...
<head>
  ...
  <meta name="apple-mobile-web-app-title" content="Jovia">
  <title>Jovia Network · Bot Console</title>
...
<div class="topbar">
  <div class="brand">
    ...
    <div>
      <div class="brand-name">Jovia Network</div>
...
<div class="stats">
  ...
  <div class="stat cb">
    ...
    <div class="sv" id="sPay">—</div><div class="sn">Ready to register</div>
  </div>
  <div class="stat cp">
...
(function () {
  ...
  function exportLogs(){
    ...
    a.download='jovia-logs-'+date+'.txt';
    a.click();
  }
...
async def handle_message(event, client):
    ...
    # ── 7b. Social-referral opener ("From Facebook, I'm Interested in
    #        getting started with Jovia") — not limited to brand-new contacts. Any
    ...
    #        message is still counted in the social-prompt stats either
...
async def _telegram_task(client):
    ...
    log.info(f"✅ Jovia Network userbot connected to Telegram | Dashboard on port {PORT}")
